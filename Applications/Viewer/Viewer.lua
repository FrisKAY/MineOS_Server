...
local pathToApplicationResources = "MineOS_Server/Applications/Viewer.app/Resources/"
local currentPath = "MineOS_Server/Pictures/"
local imageList = {}
...
local wallpaperImage = image.load("MineOS_Server/System/OS/Icons/Computer.pic")
...
while true do
	...
	if e[1] == "touch" then
		...
		elseif clicked(e[3], e[4], obj.wallpaper) then
			...
			buffer.draw()
			ecs.createShortCut("MineOS_Server/System/OS/Server.lnk", imageList[currentImage])
